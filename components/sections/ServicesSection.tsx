        ...
        <div className="text-center max-w-4xl mx-auto mb-10">
          ...
          >
            <div className="relative inline-flex items-center my-2 max-w-full">
              ...
              {/* Main Sleek Compact Horizontal Deep Navy Blue Bar */}
              <div className="relative bg-[#0A2540] text-white shadow-[0_8px_20px_-4px_rgba(10,37,64,0.45)] pl-9 sm:pl-13 pr-5 sm:pr-8 py-2 sm:py-2.5 flex items-center justify-center border-y-2 border-r-2 border-[#1B365D] rounded-r-md">
                <h2 className="text-lg sm:text-2xl lg:text-3xl font-black uppercase tracking-wider text-white drop-shadow-md">
                  What We Offer
                </h2>
              </div>
              ...
              <div className="absolute -left-4 sm:-left-6 top-1/2 -translate-y-1/2 z-20 pointer-events-none">
                <div className="relative w-10 h-10 sm:w-14 sm:h-14">
                  ...
                  <div className="absolute inset-0 rounded-full bg-gradient-to-b from-[#FAFDFE] to-[#E2E8F0] border-2 border-[#CBD5E1] shadow-[0_4px_12px_rgba(0,0,0,0.3)] flex items-center justify-center z-10">
                    <div className="w-5 h-5 sm:w-7 sm:h-7 bg-black rounded-md flex items-center justify-center shadow-md">
                      <Layers className="w-3 h-3 sm:w-4.5 sm:h-4.5 text-white" />
                    </div>
                  </div>
